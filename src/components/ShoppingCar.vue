      ...
      >
        ...
        <div class="product-content">
          ...
          <div class="product-amount">
            <div data-id="1" @click="minusAmount(product)" class="minus"></div>
            <p data-id="1" v-model="product.amount" class="amount">
              {{ product.amount }}
            </p>
            <div data-id="1" @click="plusAmount(product)" class="plus"></div>
          </div>
          <div class="product-price">
            <div data-id="1" v-model="product.prices" class="price">
              ${{ product.prices }}
            </div>
          </div>
        </div>
